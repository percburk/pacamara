...
export default function UpdateProfile() {
  ...
  const handleSliders =
    ...
    (event: ChangeEvent<unknown>, newVal: number[] | number) => {
      ...
      <Box p={3}>
        ...
        <Grid container spacing={4}>
          <Grid item xs={6}>
            ...
            />
            <Typography className={classes.subheader}>Select Equipment:</Typography>
            <TextField
              label="Grinder"
              variant="outlined"
              fullWidth
            ...
            />
            <Typography className={classes.header}>Select Brew Methods*:</Typography>
            <Box className={classes.root}>
              {methods.map((method) => (
                <Chip
                  ...
                  label={method.name}
                  color={
                    newUpdates.methodsArray?.includes(method.id) ? 'primary' : 'default'
                  }
          ...
          <Grid item xs={6}>
            ...
            <Box>
              <Typography className={classes.label}>Set Extraction Window:</Typography>
              <Slider
